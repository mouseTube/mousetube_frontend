    ...
    orderProtocolMetadata() {
      for (let metadata in this.protocol_metadata) {
        for (let metadata_field in this.protocol_metadata[metadata]['metadata_field']) {
          for (let metadata_category in this.protocol_metadata[metadata]['metadata_field'][
            metadata_field
          ]['metadata_category']) {
            let name_metadata_category =
              this.protocol_metadata[metadata]['metadata_field'][metadata_field][
                'metadata_category'
              ][metadata_category]['name_metadata_category'];
